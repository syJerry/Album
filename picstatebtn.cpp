...
void PicStateBtn::setNormalIcon(){
    qDebug()<<"setNormalIcon _normal " << _normal << Qt::endl;
    QPixmap tmpPixmap;
...
void PicStateBtn::setHoverIcon(){
    qDebug()<<"setHoverIcon _hover " << _hover << Qt::endl;
    QPixmap tmpPixmap;
...
void PicStateBtn::setPressIcon(){
    qDebug()<<"setPressIcon _pressed " << _pressed << Qt::endl;
    QPixmap tmpPixmap;
...
{
    qDebug()<<"setPressIcon _normal_2 " << _normal_2 << Qt::endl;
    QPixmap tmpPixmap;
...
{
    qDebug()<<"setPressIcon _hover_2 " << _hover_2 << Qt::endl;
    QPixmap tmpPixmap;
...
{
    qDebug()<<"setPressIcon _pressed_2 " << _pressed_2 << Qt::endl;
    QPixmap tmpPixmap;
